...
const { getAdminStats, getChatRequests, getUsersList, sendNotification, getAllUsers, deleteUser, getUserDemographics, getNotifications, getAllProducts, deleteProduct, createProduct, getAllCategories, createCategory, deleteCategory } = require('../controllers/adminController');
